...
sudo apt install xorg-dev gfortran libreadline-dev libcurl4-openssl-dev libssl-dev libgsl-dev libcurl4-openssl-devs
sudo apt install curl build-dep r-base
mkdir -p ~/R/history/
