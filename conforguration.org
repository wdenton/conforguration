...
To get the dotfiles set up on the command line, run ~dotfiles/local-dotfile-setup.sh~.  That will copy everything into place.
...
#+BEGIN_SRC shell :results output
dotfiles/local-dotfile-setup.sh
#+END_SRC
